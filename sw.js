...
const VERSION = 'tg-v11.10';
const CACHE_NAME = `trade-genius-${VERSION}`;

const CORE = [
  './',
  './index.html',
  './scene-01.html?v=1110',
  './scene-02.html?v=1110',
  './scene-03.html?v=1110',
  './scene-04.html?v=1110',
  './scene-05.html?v=1110',
  './scene-06.html?v=1110',
  './scene-07.html?v=1110',
  './scene-08.html?v=1110',
  './scene-09.html?v=1110',
  './scene-10.html?v=1110',
  './scene-11.html?v=1110',
  './bill_20.webp?v=1',
  './bill_20.png?v=1',
  './tg-common.js?v=1110',
  './tg-analyst.js?v=1110',
  './tg-bubble.js?v=1110',
  './tg-winner.js?v=1110',
  './icon.svg',
  './icon-192.png',
