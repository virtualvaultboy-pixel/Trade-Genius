...
const VERSION = 'tg-v11.13';
const CACHE_NAME = `trade-genius-${VERSION}`;

const CORE = [
  './',
  './index.html',
  './scene-01.html?v=1113',
  './scene-02.html?v=1113',
  './scene-03.html?v=1113',
  './scene-04.html?v=1113',
  './scene-05.html?v=1113',
  './scene-06.html?v=1113',
  './scene-07.html?v=1113',
  './scene-08.html?v=1113',
  './scene-09.html?v=1113',
  './scene-10.html?v=1113',
  './scene-11.html?v=1113',
  './bill_20.webp?v=1',
  './bill_20.png?v=1',
  './tg-common.js?v=1113',
  './tg-analyst.js?v=1113',
  './tg-bubble.js?v=1113',
  './tg-winner.js?v=1113',
  './icon.svg',
  './icon-192.png',
